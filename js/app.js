//получение данных с db.json-сервера и перевод их в массив producrsArr (Это нужно, т к нет backend и json-серв имитирует его)
getProducts();

async function getProducts(){
    const response = await fetch('http://localhost:3000/dishes'); //получение данных с db.json-сервера

    const productsArr = await response.json(); //перевод данных, полученных с json сервера в массив productsArr
